            ...
            <div key={id} className={`flex flex-row items-center justify-between gap-4 w-full ${util.container.class} p-2`}>
                <input 
                    ...
                    <Link 
                        ...
                        >
                        <div>{title}</div>
                        <div className='flex flex-row gap-2 justigy-center items-center'>
            ...
            {isEmotionDiaryExists ? (
                <>
                    ...
                    <button
                        ...
                        >
                        {isRemoveSelected ? `선택된 ${removeSelected.length}개의 일기를 삭제합니다.` : `선택된 일기가 없습니다`}
                    </button>
                </>
            ) : (
